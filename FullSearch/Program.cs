        ...
        static void Main(string[] args)
        {
            var host = Host.CreateDefaultBuilder(args)
                .ConfigureServices(services =>
                {
                    ...
                    {
                        options.UseSqlServer(@"data source=(localdb)\MSSQLLocalDB;initial catalog=DocumentsDatabase;User Id=DocumentsDatabaseUser;Password=125;MultipleActiveResultSets=True;App=EntityFramework");
                    });
