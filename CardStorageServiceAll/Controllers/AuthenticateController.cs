...
namespace CardStorageService.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        private readonly IAuthenticateService<AuthenticationResponse, AuthenticationRequest, SessionInfo> _authenticateService;

        #endregion

        #region Constructors

        public AuthenticateController(IAuthenticateService<AuthenticationResponse, AuthenticationRequest, SessionInfo> authenticateService)
        {
